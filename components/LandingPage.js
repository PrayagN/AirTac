    ...
    <div className="bg-surface text-on-surface font-body selection:bg-primary/30 min-h-screen dark">
      ...
      <nav className="fixed top-0 w-full z-50 bg-transparent backdrop-blur-xl dark:bg-[#0b1326]/60 shadow-[0_8px_32px_0_rgba(11,19,38,0.08)]">
        <div className="flex justify-between items-center w-full px-8 py-6 max-w-7xl mx-auto font-['Plus_Jakarta_Sans'] tracking-tight">
          ...
          <div className="flex items-center gap-4">
            <button onClick={openCreateModal} className="px-6 py-2 rounded-full border border-outline-variant/30 text-[#bcc7de] hover:opacity-80 transition-all duration-300 active:scale-95">Start Session</button>
            <button onClick={openJoinModal} className="px-6 py-2 rounded-full bg-primary-container text-on-primary-container font-semibold hover:opacity-80 transition-all duration-300 active:scale-95">Join Room</button>
          </div>
        </div>
      </nav>
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 z-10">
              ...
              <div className="flex flex-wrap gap-6">
                <button onClick={openJoinModal} className="px-10 py-4 rounded-full bg-gradient-to-r from-primary to-primary-container text-on-primary font-bold text-lg hover:opacity-90 transition-all duration-300 active:scale-95 shadow-xl shadow-primary/20">
                  Enter Room Code
                </button>
                <button onClick={openCreateModal} className="px-10 py-4 rounded-full bg-surface-container-highest border border-outline-variant/20 text-on-surface font-bold text-lg hover:bg-surface-variant transition-all duration-300 active:scale-95">
                  Learn More
                </button>
              </div>
            </div>
        ...
        <section className="py-24 px-8 bg-surface-container-lowest">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2 group relative overflow-hidden rounded-[2rem] bg-surface-container p-12 transition-all duration-500 hover:bg-surface-container-high border border-outline-variant/10">
              ...
              <div className="group relative overflow-hidden rounded-[2rem] bg-surface-container p-12 transition-all duration-500 hover:bg-surface-container-high border border-outline-variant/10">
        ...
        <section id="games" className="py-32 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="relative group h-[450px] rounded-[2.5rem] overflow-hidden bg-surface-container border border-outline-variant/10 shadow-lg transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="relative group h-[450px] rounded-[2.5rem] overflow-hidden bg-surface-container-low border border-dashed border-outline-variant/40 flex flex-col items-center justify-center text-center p-10 grayscale hover:grayscale-0 transition-all duration-500">
              ...
              <div className="relative group h-[450px] rounded-[2.5rem] overflow-hidden bg-surface-container-lowest border border-outline-variant/10 p-10 flex flex-col justify-end">
        ...
        <section className="py-32 px-8">
          <div className="max-w-5xl mx-auto glass-panel rounded-[3rem] p-16 text-center border border-primary/10 relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button onClick={openCreateModal} className="px-12 py-5 rounded-full bg-gradient-to-r from-primary to-primary-container text-on-primary font-black text-xl hover:opacity-90 shadow-2xl shadow-primary/30 transition-all duration-300">
                Start Session
              </button>
      ...
      {showInputModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-8">
          <div className="glass-panel w-full max-w-md rounded-3xl p-8 border border-outline-variant/30 shadow-2xl relative">
            ...
            <div className="space-y-4 mb-8">
              <div>
                <label className="block text-secondary text-sm font-bold mb-2">NICNAME (REQUIRED)</label>
                <input
                  type="text"
                  autoFocus
